...
print("=" * 60)
          ...
          \subsubsection{Kết quả thu được}
               \begin{itemize}
                    ...
                    \begin{figure}[H]
                         \centering
                         \includegraphics[width=0.8\textwidth]{pictures/section6/s6_p4_Result.png}
