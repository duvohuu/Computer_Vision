\section{Câu 5}
     ...
     \subsection{Các bước thực hiện}
          ...
          \end{figure}
          \hspace*{0.6cm}\textbf{So sánh và nhận xét:} So với ma trận thông số nội $K$ thu được từ phương pháp calib gián tiếp, có sự sai khác giữa các hệ số $f_x, f_y, c_x, c_y$. Nguyên nhân có thể đến từ cách lấy các điểm dữ liệu khác nhau và nhiễu trong quá trình lấy mẫu.
