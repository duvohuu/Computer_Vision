     ...
     \subsection{Các bước thực hiện}
          ...
          \begin{itemize}
               ...
               \begin{minipage}{0.48\textwidth}
                    \centering
                    \includegraphics[width=0.7\textwidth]{pictures/section5/c5_p01_setup1.jpg}
               \end{minipage}
               \hfill
               \begin{minipage}{0.48\textwidth}
                    \centering
                    \includegraphics[width=0.7\textwidth]{pictures/section5/c5_p01_setup2.jpg}
               \end{minipage}
               ...
               \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\textwidth]{pictures/section5/c5_p01_h467.jpg}
