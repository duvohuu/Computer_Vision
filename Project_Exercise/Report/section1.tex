\section{Câu 1}
    ...
    \subsection{Xác định các thông số sử dụng cho tính toán}
        \subsubsection{Lựa chọn camera}
            \hspace*{0.6cm}Vì camera nhìn từ trên xuống nên FOV tối thiểu thực tế = chiều dài tối thiểu x chiều rộng tối thiểu = 268mm x 164mm. \\
        ...
        \subsection{Tính toán theo lý thuyết}
            ...
            \end{itemize}
            \hspace*{0.6cm}\textbf{Kết luận:} FOV tính toán lớn hơn FOV tối thiểu yêu cầu, đảm bảo camera có thể quan sát toàn bộ vùng làm việc cần thiết.
            \cleardoublepage
