        ...
        \subsubsection{Kết quả thu được}
            \begin{itemize}
                \item Đồ thị cumulative explained variance:
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=1\textwidth]{pictures/section2/s2_p2_Cumulative_Explained_Variance.png}
                ...
                \item Kết quả khôi phục ảnh với số lượng eigenvectors theo ngưỡng phương sai 95\% ($k=35$):
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.75\textwidth]{pictures/section2/s2_p3_Reconstructed_Image_Threshold_95.png}
                ...
                \item Kết quả khôi phục ảnh với số lượng eigenvectors theo ngưỡng phương sai 100\% ($k=299$):
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.75\textwidth]{pictures/section2/s2_p4_Reconstructed_Image_Threshold_100.png}
